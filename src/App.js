    ...
    return (
      <Router>
        <div>
          ...
          <Switch>
          <Route exact path="/"><News key="gk" pageSize={5} country="in" category="general"/></Route>
            <Route exact path="/business"><News key="business" pageSize={5} country="in" category="business"/></Route>
            <Route exact path="/entertainment"><News key="entertainments" pageSize={5} country="in" category="entertainment"/></Route>
